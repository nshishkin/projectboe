...
Combat mechanics emphasize tactical positioning, with different unit types having advantages and disadvantages against others. The battlefield uses a configurable grid system (default 10x16) where terrain affects movement and combat effectiveness, with elevation, cover, and flanking playing important roles.
